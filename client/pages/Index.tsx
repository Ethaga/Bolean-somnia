      ...
      <div className="container mx-auto py-24 md:py-32 relative">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-2xl">
            Build and deploy fully on‑chain dApps on Somnia Testnet with Bolean
            — create lending markets, experiments, and production protocols.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a href="#architecture">
              <Button variant="outline">See Architecture</Button>
            </a>
          </div>
        </div>
      </div>
...
function Markets({ account }: { account: Address | null }) {
  const tokenAddresses = useMemo(
    () => Object.values(BOLEAN_ADDRESSES.tokens) as Address[],
    [],
  );
  ...
  async function sendToken() {
    if (!sendTokenAddr || !sendTo || !sendAmount)
      return alert("Please provide recipient and amount");
    const eth = (window as any).ethereum;
      ...
      (async () => {
        try {
          ...
          t.update({
            ...
            description: "Still pending after timeout",
          });
        } catch (err) {
      ...
      <div className="flex items-end justify-between gap-6 flex-wrap">
        <div>
          ...
          <p className="mt-2 text-muted-foreground max-w-2xl">
            Supply and borrow assets on Somnia. Connect your wallet to see
            balances. Actions are read‑only in this demo until contracts are
            fully deployed for Bolean.
          </p>
        </div>
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-5">
        {tokenAddresses.map((addr) => {
          ...
          return (
            <div
              key={addr}
              className="rounded-xl border border-border/60 bg-card/60 p-5 shadow-sm backdrop-blur"
            >
              ...
              <div className="mt-4 grid grid-cols-3 gap-3">
                ...
                <Button onClick={() => openSend(addr)} className="bg-white/6">
                  Send
                </Button>
              </div>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="w-full max-w-lg rounded-xl bg-card/90 p-6">
            <h3 className="text-lg font-semibold">
              Send {symbols[sendTokenAddr] ?? "Token"}
            </h3>
...
function Architecture() {
  return (
    <div className="container mx-auto">
      ...
      <p className="mt-2 text-muted-foreground max-w-2xl">
        Modular, on‑chain lending protocol built for Somnia. Frontend
        reads/writes via wallet. Contracts composed of LendingPool,
        InterestRateModel, RiskEngine, and Token adapters.
      </p>
      <div className="mt-8 overflow-hidden rounded-2xl border border-border/60 bg-card/60 shadow-sm">
        <svg
          ...
          role="img"
          aria-label="Bolean Architecture Diagram"
        >
          <defs>
          ...
          <g>
            ...
            <text
              ...
              fill="currentColor"
            >
              Frontend (Bolean dApp)
            </text>
            <text x="80" y="120" fontSize="16" fill="currentColor">
              React + Viem + Wallet (EIP‑1193)
            </text>
          </g>
          <g>
            <rect
            ...
            <text x="450" y="120" fontSize="16" fill="currentColor">
              JSON‑RPC via wallet / public RPC
            </text>
          </g>
          <g>
            <rect
            ...
            <text x="820" y="120" fontSize="16" fill="currentColor">
              Shannon Explorer
            </text>
          </g>
          ...
          <g>
            ...
            <text x="80" y="270" fontSize="16" fill="currentColor">
              LendingPool, Risk, Interest
            </text>
            <rect
              x="80"
              y="290"
              ...
              stroke="#06b6d4"
            />
            <text x="95" y="325" fontSize="16" fill="currentColor">
              LendingPool: {BOLEAN_ADDRESSES.lendingPool}
            </text>
            <rect
              x="80"
              y="360"
              ...
              stroke="#d946ef"
            />
            <text x="95" y="385" fontSize="16" fill="currentColor">
              Rates + Risk (modular)
            </text>
          </g>
          ...
          <g>
            ...
            <text x="450" y="270" fontSize="16" fill="currentColor">
              ERC‑20 tokens
            </text>
            <rect
              x="450"
              ...
              fill="transparent"
            />
            <text x="465" y="320" fontSize="16" fill="currentColor">
              Token A: {BOLEAN_ADDRESSES.tokens.tokenA}
            </text>
            <rect
              x="450"
              y="350"
              ...
              fill="transparent"
            />
            <text x="465" y="380" fontSize="16" fill="currentColor">
              Token B: {BOLEAN_ADDRESSES.tokens.tokenB}
            </text>
            <rect
              x="450"
              y="410"
              ...
              fill="transparent"
            />
            <text x="465" y="440" fontSize="16" fill="currentColor">
              Token C: {BOLEAN_ADDRESSES.tokens.tokenC}
            </text>
          </g>
          ...
          <g>
            ...
            <text x="820" y="270" fontSize="16" fill="currentColor">
              MetaMask & EIP‑1193 compatible
            </text>
            <text x="820" y="310" fontSize="16" fill="currentColor">
              - Connect, Switch network
            </text>
            <text x="820" y="340" fontSize="16" fill="currentColor">
              - Sign transactions
            </text>
            <text x="820" y="370" fontSize="16" fill="currentColor">
              - Read balances
            </text>
          </g>

          <path
            d="M230 150 C 230 180, 600 180, 600 150"
            stroke="url(#g1)"
            strokeWidth="3"
            fill="none"
          />
          <path
            d="M600 150 C 600 180, 970 180, 970 150"
            stroke="url(#g1)"
            strokeWidth="3"
            fill="none"
          />
          <path
            d="M230 200 C 230 180, 230 160, 230 150"
            stroke="#06b6d4"
            strokeWidth="2"
            fill="none"
          />
          <path
            d="M600 200 C 600 180, 600 160, 600 150"
            stroke="#06b6d4"
            strokeWidth="2"
            fill="none"
          />
...
function Contracts() {
  ...
  return (
    <div className="container mx-auto">
      ...
      <p className="mt-2 text-muted-foreground max-w-2xl">
        Deployed on Somnia Testnet. Use the explorer links to verify source and
        activity.
      </p>
      <div className="mt-6 grid gap-4 md:max-w-3xl">
        {entries.map((e) => (
          <div
            key={e.addr}
            className="flex items-center justify-between gap-4 rounded-xl border border-border/60 bg-card/60 p-4 shadow-sm"
          >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              href={`https://shannon-explorer.somnia.network/address/${e.addr}`}
            >
              Explorer
            </a>
          </div>
...
function Docs() {
  return (
    <div className="container mx-auto">
      ...
      <p className="mt-2 text-muted-foreground max-w-2xl">
        Learn how to build and deploy on Somnia. Follow network info and
        developer guides.
      </p>
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
        <a
          className="group rounded-xl border border-border/60 bg-card/60 p-6 shadow-sm hover:border-primary/60"
        ...
        >
          ...
          <div className="mt-2 text-muted-foreground">
            Core documentation, guides and concepts.
          </div>
        </a>
        <a
          className="group rounded-xl border border-border/60 bg-card/60 p-6 shadow-sm hover:border-primary/60"
          href="https://docs.somnia.network/developer/network-info"
          target="_blank"
          rel="noreferrer"
        >
          <div className="text-lg font-semibold group-hover:text-primary">
          ...
          <div className="mt-2 text-muted-foreground">
            RPC endpoints, chain ID and explorer links.
          </div>
        </a>
      </div>
    </div>
...
export default function Index() {
  ...
  useEffect(() => {
    ...
    let onAcc: ((accs: string[]) => void) | null = null;

    if (eth) {
      eth.request({ method: "eth_accounts" }).then((accs: string[]) => {
        if (accs?.[0]) setAccount(accs[0] as Address);
      });
      onAcc = (accs: string[]) => setAccount((accs?.[0] as Address) ?? null);
      eth.on?.("accountsChanged", onAcc);
    }

    return () => {
      window.removeEventListener(
        "bolean:accountChanged",
        handler as EventListener,
      );
      if (eth && onAcc) eth.removeListener?.("accountsChanged", onAcc);
    };
  }, []);
  ...
  return (
    <Layout>
      ...
      <Section id="tokens" className="py-16 md:py-24">
        <div className="container mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold">
            Tokens on Somnia Testnet
          </h2>
          <p className="mt-2 text-muted-foreground max-w-2xl">
            Notable tokens deployed on Somnia Testnet and explorer links.
          </p>
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
            <a
              className="group rounded-xl border border-border/60 bg-card/60 p-6 shadow-sm hover:border-primary/60"
              href="https://shannon-explorer.somnia.network/token/0x65296738D4E5edB1515e40287B6FDf8320E6eE04"
              target="_blank"
              rel="noreferrer"
            >
              <div className="text-lg font-semibold">0x6529...EE04</div>
              <div className="mt-2 text-muted-foreground">
                View token on Shannon Explorer
              </div>
              <div className="mt-4 text-sm text-muted-foreground break-all">
                https://shannon-explorer.somnia.network/token/0x65296738D4E5edB1515e40287B6FDf8320E6eE04
              </div>
            </a>
          </div>
        </div>
